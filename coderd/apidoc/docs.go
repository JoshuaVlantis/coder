    ...
    "paths": {
        ...
        "/boundary/sessions/{id}/logs": {
            "get": {
                ...
                "operationId": "get-boundary-session-logs",
                "parameters": [
                    {
                        "type": "string",
                        "format": "uuid",
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/codersdk.BoundarySessionLogsResponse"
                        }
                    }
                },
                "security": [
        ...
        "codersdk.BoundarySessionLogsResponse": {
            ...
            "properties": {
                "results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/codersdk.BoundaryLog"
                    }
                }
            }
        },
