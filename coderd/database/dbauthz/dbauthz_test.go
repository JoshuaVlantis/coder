...
func (s *MethodTestSuite) TestOrganization() {
	...
	s.Run("InsertTemplateVersionDLPPolicy", s.Mocked(func(dbm *dbmock.MockStore, _ *gofakeit.Faker, check *expects) {
		arg := database.InsertTemplateVersionDLPPolicyParams{ID: uuid.New(), TemplateVersionID: uuid.New(), Name: "strict"}
