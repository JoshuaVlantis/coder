...
Write out the current server config as YAML to stdout.`,
		...
		},
		{
			...
			Description: "Deprecated: use --ai-gateway-proxy-domain-allowlist or CODER_AI_GATEWAY_PROXY_DOMAIN_ALLOWLIST instead. This value is now derived automatically from the configured AI Bridge providers' base URLs. Setting this value has no effect. This option will be removed in a future release.",
...
// AIBridgeProviderConfig represents a single AI Gateway provider instance,
