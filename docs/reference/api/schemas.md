...
## codersdk.BoundarySessionLogsResponse
...
| Name      | Type                                                  | Required | Restrictions | Description |
|-----------|-------------------------------------------------------|----------|--------------|-------------|
| `results` | array of [codersdk.BoundaryLog](#codersdkboundarylog) | false    |              |             |
